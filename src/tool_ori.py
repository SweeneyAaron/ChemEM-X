...
class RenderBindingSite:
    def __new__(cls, session, binding_site, current_model, current_map=None):
    ...
    def __init__(self, session, binding_site, current_model, current_map=None):
...
class RenderAutoBindingSite(RenderBindingSite):
    def __init__(self, session, binding_site, current_model, current_map=None):
        ...
        super().__init__(session, binding_site, current_model, current_map)
    ...
    def render_map(self):
        # Auto-specific map rendering
        if self.map is not None:
            pass  # Your auto rendering code here.
    ...
    def render_map(self):
        if self.map is not None:
            ...
            max_i = min_i + binding_site_grid_size[0] - 1
            max_j = min_j + binding_site_grid_size[1] - 1
            max_k = min_k + binding_site_grid_size[2] - 1
