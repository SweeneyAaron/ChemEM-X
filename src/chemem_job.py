    ...
    def run(self, *args, **kw):
        ...
        while self.running :
            ...
            if not self._pause:
                ...
                #self.chemem.update_simulation_model()
                self.chemem.update_simulation_model_vectorised()
            ...
            if self._set_map_bias is not None:
                self.chemem.simulation.set_map_bias(self._set_map_bias)
                self.chemem.update_simulation_model()
                self._set_map_bias = None
            #Tug---------------------------
            ...
            if self.weak_hbond_tug is not None:
                ...
                self.chemem.simulation.update_weak_hbond_tug_force_for_atom(self.weak_hbond_tug[0],
            ...
            if self.cation_pi_tug is not None:
                self.chemem.simulation.update_cation_pi_tug(self.cation_pi_tug[0],
            ...
            if self.saltbridge_tug is not None:
                self.chemem.simulation.update_saltbridge_tug_force_for_atom(self.saltbridge_tug[0], distance_k=self.saltbridge_tug[1])
                self.saltbridge_tug = None
            
            if self.halogen_bond_tug is not None:
                self.chemem.simulation.update_halogen_bond_tug_force_for_atom( self.halogen_bond_tug[0], 
